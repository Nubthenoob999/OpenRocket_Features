...
public record SamplingConfiguration(double[] mach, double[] alphaRad, double[] betaRad) {
	private static final double[] DEFAULT_MACH = {0, 0.1, 0.2, 0.3, 0.5, 0.7, 0.8,
			0.85, 0.9, 0.95, 1.0, 1.05, 1.1, 1.2, 1.3, 1.5, 2, 3, 4, 5, 6, 7, 8};
	private static final double[] DEFAULT_ALPHA_DEG = {-90, -75, -60, -45, -40, -35, -30,
			-25, -20, -15, -10, -5, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 60, 75, 90};
	 ...
	 * The Mach-8 endpoint covers the repository's Mach-7.22 Black Brant flight
	 * while remaining inside the Mach-10 A53D02/high-Mach solver domain.
	 */
