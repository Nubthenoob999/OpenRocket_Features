...
public class RomAerodynamicCalculator extends AbstractAerodynamicCalculator {
	...
	private static final double BOOST_CD_RATIO_GUARDRAIL_LOW = 0.82;
	private static final double BOOST_CD_RATIO_GUARDRAIL_HIGH = 1.20;
	private static final double COAST_CD_RATIO_GUARDRAIL_LOW = 0.82;
	private static final double COAST_CD_RATIO_GUARDRAIL_HIGH = 1.25;
	private static final double BOOST_CD_ENVELOPE_MIN = 0.88;
	private static final double BOOST_CD_ENVELOPE_MAX = 1.12;
	private static final double COAST_CD_ENVELOPE_MIN = 0.88;
	private static final double COAST_CD_ENVELOPE_MAX = 1.12;
