...
public class FlightDataType implements Comparable<FlightDataType>, Groupable<FlightDataTypeGroup>, DataType {
	...
	public static final FlightDataType TYPE_ORIENTATION_QW = newType("orientation_qw", trans.get("FlightDataType.TYPE_ORIENTATION_QW"),
			"Qw", UnitGroup.UNITS_COEFFICIENT,
			FlightDataTypeGroup.ORIENTATION, 6);
	//// Orientation quaternion X component
	public static final FlightDataType TYPE_ORIENTATION_QX = newType("orientation_qx", trans.get("FlightDataType.TYPE_ORIENTATION_QX"),
			"Qx", UnitGroup.UNITS_COEFFICIENT,
			FlightDataTypeGroup.ORIENTATION, 7);
	//// Orientation quaternion Y component
	public static final FlightDataType TYPE_ORIENTATION_QY = newType("orientation_qy", trans.get("FlightDataType.TYPE_ORIENTATION_QY"),
			"Qy", UnitGroup.UNITS_COEFFICIENT,
			FlightDataTypeGroup.ORIENTATION, 8);
	//// Orientation quaternion Z component
	public static final FlightDataType TYPE_ORIENTATION_QZ = newType("orientation_qz", trans.get("FlightDataType.TYPE_ORIENTATION_QZ"),
