...
public class SimulationReplayPanel extends JPanel implements GLEventListener {
    ...
    private static final String[] SPEED_LABELS = { "0.1x", "0.25x", "0.5x", "1x", "2x", "5x", "10x" };
    private static final int DEFAULT_SPEED_IDX = 3; // 1x
    ...
    private void updateStatsDisplay(int f) {
        ...
        statTheta.setText(String.format("%.1f deg", Math.toDegrees(theta)));
        statHdg.setText(String.format("HDG %.0f deg", (Math.toDegrees(phi) % 360 + 360) % 360));
        updateEventLog();
        if (miniRocketView != null) {
    ...
    private JPanel buildStatsPanel() {
        ...
        statHdg = makeValueLabel("HDG 0 deg");
        gbc.gridy = 1;
        ...
        JButton eventFilterBtn = new JButton("Events");
